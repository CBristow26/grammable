...
RSpec.describe GramsController, type: :controller do
  ...
  describe "grams#update action" do
    ...
    it "shouldn't let unauthneticated users create a gram" do
      gram = FactoryGirl.create(:gram)
    ...
    describe "grams#edit action" do
      it "shouldn't let a user who did not creaet the gram edit a gram" do
        gram = FactoryGirl.create(:gram)
        user = FactoryGirl.create(:user)
        sign_in user
        get :edit, id: gram.id
      ...
      it "shouldn't let unauthneticated users edit a gram" do
        gram = FactoryGirl.create(:gram)
        get :edit, id: gram.id
        expect(response).to redirect_to new_user_session_path
      end
      ...
      it "should return a 404 error sage if the gram is not found" do
        user = FactoryGirl.create(:user)
        sign_in user
